            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
                        From voice to <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-400">insight</span>.
                    </h2>
                ...
                <div className="relative max-w-4xl mx-auto">
                    {/* Vertical Line */}
                    <div className="absolute left-[20px] md:left-1/2 top-0 bottom-0 w-0.5 bg-slate-800 md:-translate-x-1/2" />
                    ...
                    <motion.div
                        ...
                        className="absolute left-[20px] md:left-1/2 top-0 w-0.5 bg-gradient-to-b from-indigo-500 via-blue-500 to-slate-900 md:-translate-x-1/2 origin-top"
                    />
                    ...
                    <div className="space-y-12 md:space-y-24">
                        {steps.map((step, index) => (
                            ...
                            >
                                {/* Timeline Node */}
                                <div className="absolute left-[-8px] md:left-1/2 w-14 h-14 rounded-full bg-slate-900 border border-slate-700 flex items-center justify-center z-10 md:-translate-x-1/2">
                                ...
                                {/* Content Card */}
                                <div className={`ml-12 md:ml-0 w-full md:w-[calc(50%-3rem)] p-4 md:p-6 rounded-2xl bg-slate-900/40 backdrop-blur-md border border-white/5 hover:border-white/10 transition-all group ${index % 2 === 0 ? 'text-left' : 'md:text-right'
                                    }`}>
