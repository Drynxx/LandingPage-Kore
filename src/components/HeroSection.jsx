                ...
                <div className="space-y-8 z-10">
                    ...
                    >
                        <a
                            ...
                            className="group relative px-8 py-4 bg-indigo-600 rounded-full text-white font-semibold text-lg transition-all hover:bg-indigo-500 hover:scale-105 animate-glow-pulse flex items-center gap-2 inline-flex"
                        >
                            Get Started
                ...
                >
                    ...
                    >
                        <GlassCard className="p-6 w-full max-w-md aspect-[4/3] relative overflow-hidden bg-gradient-to-br from-slate-900/80 to-slate-800/80 border-slate-700/50">
                            ...
                            <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-indigo-900/50 to-transparent flex items-end justify-center pb-6 gap-1">
                                {[...Array(8)].map((_, i) => (
                                    <motion.div
                                        key={i}
